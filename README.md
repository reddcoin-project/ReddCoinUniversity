...
1. Edit any of the [docs files](https://github.com/reddcoin-project/ReddCoinUniversity/tree/master/app/assets/docs);
...
1. Clone this repo: `git clone https://github.com/reddcoin-project/ReddCoinUniversity.git`;
